      ...
      <div className="container mx-auto max-w-6xl p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-green-700">En tu perfil puedes personalizar tus intolerancias y preferencias alimentarias</p>
          </div>
          <Link href="/perfil">
            ...
            <Card className="cursor-pointer border-green-200 transition-colors hover:bg-green-50">
              <CardContent className="flex items-center gap-4 p-6 py-[22px] px-[22px]">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {metaActiva ? "Seguimiento de objetivos" : "Utiliza nuestra calculadora de calorías"}
                  </p>
                </div>
              </CardContent>
            </Card>
